...
class AnaliseCenario:
    ...
    def plota_mapa_basico_setores_censitarios(self, fundo_ivs: bool = True):
        ...
        cols_indices_to_plot = ["Setor", "Populacao_Total", "IVS"]
...
def main():
    path_cenario = r"C:\Users\marce\OneDrive\Área de Trabalho\MestradoHierarquico\Resultados_COBERTURA_MAXIMA_23_END.xlsx"
    analise_cen = AnaliseCenario(path_cenario=path_cenario)
    analise_cen.plota_mapa_basico_setores_censitarios()
